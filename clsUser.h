...
private:
    ...
    static void _SaveUsersDataToFile(vector <clsUser> vUsers)
    {
        ...
        fstream MyFile;
        MyFile.open(UsersPath, ios::out);//overwrite
    ...
    {
        fstream MyFile;
        MyFile.open(UsersPath, ios::out | ios::app);
...
public:
    ...
    void RegisterLogIn()
    {
        ...
        fstream MyFile;
        MyFile.open(LoginRegisterPath, ios::out | ios::app);
    ...
    static  vector <stLoginRegisterRecord> GetLoginRegisterList()
    {
        ...
        fstream MyFile;
        MyFile.open(LoginRegisterPath, ios::in);//read Mode
